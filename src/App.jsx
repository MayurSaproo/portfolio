      ...
      <main className="max-w-5xl mx-auto px-6 pb-24">
        ...
        <section id="portfolio" className="py-20 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow group">
              <div className="bg-slate-100 h-48 rounded-xl mb-6 overflow-hidden relative">
                <img src={imgH} alt="Jelium.ai" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-2">METAGER</h3>
              <p className="text-sm text-slate-600 mb-4">Generates meta tags and provides live social media preview forecasting. Ensures optimized link appearance across all platforms.</p>
              <a href="https://metager.vercel.app/" target="_blank" rel="noreferrer" className="text-indigo-600 font-medium text-sm inline-flex items-center gap-1 hover:gap-2 transition-all">Demo →</a>
            </div>
          </div>
        </section>
